const CACHE='offramp-v1';
const ASSETS=['./','./index.html','./manifest.webmanifest','./icon.svg','./kernel/offramp.mjs','./kernel/sha256.mjs','./kernel/attractor.mjs','./kernel/fold.mjs','./kernel/eth.mjs'];
